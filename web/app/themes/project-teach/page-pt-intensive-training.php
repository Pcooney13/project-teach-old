                	        ...
                	        <div style="flex-wrap:wrap;" class="card event__card">
                                ...
                                <div style="width:100%; margin:15px 0; text-align:right">
                                    ...
                                    if ($link):
                                        ...
                                        ?>
                                        <a style="margin-right:10px;" class="btn btn-<?php echo $currentRegion;?>" href="<?php echo esc_url($link_url); ?>" target="<?php echo esc_attr($link_target); ?>"><?php echo esc_html($link_title); ?></a>
                                    <?php endif; ?>
                                    <!-- Print PDF -->
                                    <?php $file = get_field('pdf_print');
                                    if ($file): ?>
                                        <a class="btn btn-orange" href="<?php echo $file['url']; ?>"><?php echo $file['title']; ?></a>
                                    <?php endif; ?>
                                </div>
                                <!-- Event Schedule PDFs -->
                                ...
                                <?php if(get_field('follow_up_session_call_out')) : ?>
                                    ...
                                    <?php
                                        ...
                                        <?php $fu_link = get_field('follow_up_link');
                                        if ($fu_link):
